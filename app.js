...
import BroadcastService from "./websocketServer/websocketServer.js"; // Import BroadcastService
...
const broadcastService = new BroadcastService(server); // Initialize BroadcastService here
...
// Routes
app.get("/", (req, res) => {
  res.status(200).json({ message: "I'm fine" });
});
...
app.put("/update-item/:id", async (req, res) => {
  ...
  broadcastService.broadcast(updatedItem); // Use the broadcast service
...
app.post("/notifications", async (req, res) => {
  ...
  broadcastService.broadcast(newNotification); // Use the broadcast service
...
export { server, broadcastService }; // Export server and broadcastService
